          ...
          children: [
            ...
            ConstrainedBox(
              ...
              child: PageView.builder(
                ...
                onPageChanged: (index) {
                  setState(() {
                    controllerObj.currentPage = index;
                  });
                },
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        Image(
                          image: AssetImage(
                            controllerObj.items[index]["image"]!,
                          ),
                        ),
                        SizedBox(height: 24),
                        Text(
                          controllerObj.items[index]["title"]!,
                        ...
                        Padding(
                          ...
                          child: Text(
                            controllerObj.items[controllerObj
                                .currentPage]["body"]!,
            ...
            Row(
              ...
              children: [
                ButtonWidget(
                  type: "onboard",
                  onPressed: () {
                    if (controllerObj.currentPage !=
                        controllerObj.items.length - 1) {
                ...
                controllerObj.currentPage != controllerObj.items.length - 1
                    ...
                    : TextButton(onPressed: null, child: SizedBox.shrink()),
              ],
            ),
          ],
        ),
