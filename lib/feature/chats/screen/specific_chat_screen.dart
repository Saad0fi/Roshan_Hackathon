    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [Icon(Icons.more_vert_rounded, color: Colors.black)],
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Image(image: AssetImage("assets/images/2 (1).png")),
                  ),
                ],
              ),
            ),
        ...
        bottomSheet: Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Image(
                  image: AssetImage("assets/images/Frame 427318934 (1).png"),
                ),
              ],
            ),
          ),
